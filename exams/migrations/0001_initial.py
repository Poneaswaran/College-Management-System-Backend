# Generated by Django 5.0.2 on 2026-02-25 18:00
...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=180, help_text="Exam duration in minutes"
                    ),
                ),
                (
                    "max_marks",
                ...
                (
                    "notes",
                    models.TextField(
                        blank=True, help_text="Additional notes for this exam schedule"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_pass",
                    models.BooleanField(
                        default=False, help_text="Whether student passed"
                    ),
                ),
                (
                    "is_absent",
                    models.BooleanField(
                        default=False, help_text="Whether student was absent"
                    ),
                ),
                (
                    "remarks",
                    models.TextField(
                        blank=True, help_text="Remarks (malpractice, medical, etc.)"
                    ),
                ),
                (
                    "published_at",
                    models.DateTimeField(
                        blank=True, help_text="When result was published", null=True
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_present",
                    models.BooleanField(
                        default=False, help_text="Whether student was present for exam"
                    ),
                ),
                (
                    "marked_at",
                    models.DateTimeField(
                        blank=True, help_text="When attendance was marked", null=True
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_eligible",
                    models.BooleanField(
                        default=True, help_text="Whether student is eligible to appear"
                    ),
                ),
                (
        ...
        migrations.AddIndex(
            model_name="exam",
            index=models.Index(
                fields=["semester", "exam_type"], name="exams_exam_semeste_5e87de_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="exam",
            index=models.Index(
                fields=["status", "start_date"], name="exams_exam_status_ab8e48_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="exam",
            index=models.Index(
                fields=["department", "semester"], name="exams_exam_departm_f4551a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="examschedule",
            index=models.Index(
                fields=["exam", "date"], name="exams_exams_exam_id_fd186a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="examschedule",
            index=models.Index(
                fields=["subject", "date"], name="exams_exams_subject_78a525_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="examschedule",
            index=models.Index(
                ...
                name="exams_exams_room_id_3ac6a6_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="examschedule",
            index=models.Index(
                fields=["section", "date"], name="exams_exams_section_39be23_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["student", "status"], name="exams_examr_student_cbc162_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="examresult",
            index=models.Index(
                fields=["schedule", "status"], name="exams_examr_schedul_c65ea8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="examresult",
            index=models.Index(
                fields=["status", "is_pass"], name="exams_examr_status_942c5e_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="examresult",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["student", "schedule"], name="exams_exams_student_559be2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="examseatingarrangement",
            index=models.Index(
                fields=["schedule", "room"], name="exams_exams_schedul_5de230_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="examseatingarrangement",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["student", "exam"], name="exams_hallt_student_e4a532_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="hallticket",
            index=models.Index(
                fields=["ticket_number"], name="exams_hallt_ticket__77c858_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="hallticket",
